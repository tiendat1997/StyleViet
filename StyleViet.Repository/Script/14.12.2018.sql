...
WHERE ([d].[parent_object_id] = OBJECT_ID(N'[Account]') AND [c].[name] = N'RoleId');
...
INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
VALUES (N'20181212094734_Remove_RoleId_In_Account', N'2.1.4-rtm-31024');

GO

ALTER TABLE [Account] ADD [FacebookId] nvarchar(max) NULL;

GO

ALTER TABLE [Account] ADD [GoogleId] nvarchar(max) NULL;

GO

ALTER TABLE [Account] ADD [Salt] nvarchar(max) NULL;

GO

INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
VALUES (N'20181214072619_AddGoogleIdAndFacebookIdInAccount', N'2.1.4-rtm-31024');
